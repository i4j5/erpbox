                ...
                <form method="post" action="{{ route('users.update', $user->id) }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <p class="text-sm text-red-600">{{ $errors->updateProfileInformation->first('email') }}</p>
                        </div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <p class="text-sm text-red-600">{{ $errors->updateProfileInformation->first('password') }}</p>
                        </div>
